...
# ╔═╡ 177035be-6491-425b-8ad3-15cbea311f59
using LinearAlgebra
...
# ╔═╡ 5943db77-9983-4a3a-8f16-3f99fc02a989
n = nv(G)

# ╔═╡ 3764b8b9-1091-4570-8972-8d9d2427dbfa
i0 = n + 1

# ╔═╡ 908a5238-49b2-4cc0-9aaa-8d01ae9398a2
E = collect(edges(G))

# ╔═╡ 2c4818b4-8a57-4e13-941d-758835b41893
begin
...
# ╔═╡ ce535e5f-aa83-4b37-83b6-bf3696642d01
w = ones(n)

# ╔═╡ 5df2c216-9cb2-43b2-be64-29a2a31b0da9
...
# ╔═╡ f58c6536-e8db-4a07-b463-359ac2a69c42
Q[i0, i0] = t
...
# ╔═╡ a4b3ab80-ad71-4761-9013-b732a4bfb2f3
Lam = sparse([src(e) for e in E],[dst(e) for e in E], Λ, n,n)  # sparse matrix of lambda_ij

# ╔═╡ 8330235d-bd4e-4c8c-bc9c-36b1edc09ed6
Qold = getQ(E,t, λ, Lam)

# ╔═╡ 9383568f-a897-49d0-8293-b8f6d9973dd5
typeof(Q)
